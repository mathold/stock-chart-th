...
# ⚠ สิงหาคม 2026 Yahoo ไม่ให้ข้อมูลย้อนหลังของ "ดัชนีไทย" อีกแล้ว
#   ทดสอบเองบนเว็บจริง: ^SET.BK · SET.BK · ^SET50.BK ว่างเปล่าหมด
#   (หน้าเว็บของ Yahoo ยังมีอยู่ แต่ API คืนข้อมูลเปล่า อย่าเชื่อแค่ว่ามีหน้า)
#   เหลือแต่หลักทรัพย์จริงที่ยังดึงได้ เช่น TDEX.BK (ETF ตาม SET50)
#
