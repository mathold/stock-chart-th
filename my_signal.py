...
# Homily ตัวจริงใช้ แดง=ซื้อ เหลือง=ขาย (แบบจีน) — ที่นี่กลับเป็นแบบสากล
# ให้เข้าชุดกับริบบิ้น เลือกเขียว/แดงที่สว่างกว่าสีริบบิ้นเพื่อไม่ให้กลืนพื้นหลัง
SIG_BUY = "#39FF6A"             # เขียวสว่าง = สัญญาณซื้อ
SIG_SELL = "#FF2D2D"            # แดงสว่าง   = สัญญาณขาย
...
def signal_colors(bull: pd.Series, de_line: pd.Series) -> pd.Series:
    ...
    เขียว  ซื้อ      = ริบบิ้นกลับเป็นเขียว หรือ DE ตัดขึ้นเหนือ 0 ตอนริบบิ้นเขียว
